...
udword formationSortType[NO_FORMATION] =
{
    ...
    FORMATION_SORT_BIGGEST_THEN_CLOSEST,      //CUSTOM_FORMATION
};
...
void processFormationToDo(struct CommandToDo *formationtodo,bool steadyFormation,bool passiveAttacked)
{
    ...
    real32 error = 0;
    vector errorvect;
    bool calcError = ((universe.univUpdateCounter % (FORMATION_ERROR_CALCULATE_RATE * UNIVERSE_UPDATE_RATE_FACTOR)) == FORMATION_ERROR_CALCULATE_FRAME);
