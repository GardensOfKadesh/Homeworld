...
{
    makeEntry(AIPLAYER_UPDATE_RATE[AI_BEGINNER], scriptSetUdwordCB),
    makeEntry(AIPLAYER_UPDATE_RATE[AI_INTERMEDIATE], scriptSetUdwordCB),
    makeEntry(AIPLAYER_UPDATE_RATE[AI_ADVANCED], scriptSetUdwordCB),
    ...
    makeEntry(AIF_RESEARCH_DELAY[AI_BEGINNER],   scriptSetUbyteCB),
    makeEntry(AIF_RESEARCH_DELAY[AI_INTERMEDIATE],   scriptSetUbyteCB),
    makeEntry(AIF_RESEARCH_DELAY[AI_ADVANCED],   scriptSetUbyteCB),

    //attackman tweaks
    makeEntry(AIA_ATTACK_FLEET_FAST_PROB[AI_BEGINNER],    scriptSetUdwordCB),
    makeEntry(AIA_ATTACK_FLEET_FAST_RANGE[AI_BEGINNER],   scriptSetUdwordCB),
    makeEntry(AIA_ATTACK_FLEET_FAST_PROB[AI_INTERMEDIATE],    scriptSetUdwordCB),
    makeEntry(AIA_ATTACK_FLEET_FAST_RANGE[AI_INTERMEDIATE],   scriptSetUdwordCB),
    makeEntry(AIA_ATTACK_FLEET_FAST_PROB[AI_ADVANCED],    scriptSetUdwordCB),
    makeEntry(AIA_ATTACK_FLEET_FAST_RANGE[AI_ADVANCED],   scriptSetUdwordCB),
    makeEntry(AIA_ATTACK_FLEET_GUARD_PROB[AI_BEGINNER],   scriptSetUdwordCB),
    makeEntry(AIA_ATTACK_FLEET_GUARD_RANGE[AI_BEGINNER],  scriptSetUdwordCB),
    makeEntry(AIA_ATTACK_FLEET_GUARD_PROB[AI_INTERMEDIATE],   scriptSetUdwordCB),
    makeEntry(AIA_ATTACK_FLEET_GUARD_RANGE[AI_INTERMEDIATE],  scriptSetUdwordCB),
    makeEntry(AIA_ATTACK_FLEET_GUARD_PROB[AI_ADVANCED],   scriptSetUdwordCB),
    makeEntry(AIA_ATTACK_FLEET_GUARD_RANGE[AI_ADVANCED],  scriptSetUdwordCB),
    makeEntry(AIA_ATTACK_FLEET_BIG_PROB[AI_BEGINNER],     scriptSetUdwordCB),
    makeEntry(AIA_ATTACK_FLEET_BIG_RANGE[AI_BEGINNER],    scriptSetUdwordCB),
    makeEntry(AIA_ATTACK_FLEET_BIG_PROB[AI_INTERMEDIATE],     scriptSetUdwordCB),
    makeEntry(AIA_ATTACK_FLEET_BIG_RANGE[AI_INTERMEDIATE],    scriptSetUdwordCB),
    makeEntry(AIA_ATTACK_FLEET_BIG_PROB[AI_ADVANCED],     scriptSetUdwordCB),
    makeEntry(AIA_ATTACK_FLEET_BIG_RANGE[AI_ADVANCED],    scriptSetUdwordCB),
    makeEntry(AIA_ATTACK_FLEET_HUGE_PROB[AI_BEGINNER],    scriptSetUdwordCB),
    makeEntry(AIA_ATTACK_FLEET_HUGE_RANGE[AI_BEGINNER],   scriptSetUdwordCB),
    makeEntry(AIA_ATTACK_FLEET_HUGE_PROB[AI_INTERMEDIATE],    scriptSetUdwordCB),
    makeEntry(AIA_ATTACK_FLEET_HUGE_RANGE[AI_INTERMEDIATE],   scriptSetUdwordCB),
    makeEntry(AIA_ATTACK_FLEET_HUGE_PROB[AI_ADVANCED],    scriptSetUdwordCB),
    makeEntry(AIA_ATTACK_FLEET_HUGE_RANGE[AI_ADVANCED],   scriptSetUdwordCB),
    makeEntry(AIA_TAKEOUT_TARGET_PROB[AI_BEGINNER],       scriptSetUdwordCB),
    makeEntry(AIA_TAKEOUT_TARGET_RANGE[AI_BEGINNER],      scriptSetUdwordCB),
    makeEntry(AIA_TAKEOUT_TARGET_PROB[AI_INTERMEDIATE],       scriptSetUdwordCB),
    makeEntry(AIA_TAKEOUT_TARGET_RANGE[AI_INTERMEDIATE],      scriptSetUdwordCB),
    makeEntry(AIA_TAKEOUT_TARGET_PROB[AI_ADVANCED],       scriptSetUdwordCB),
    makeEntry(AIA_TAKEOUT_TARGET_RANGE[AI_ADVANCED],      scriptSetUdwordCB),
    makeEntry(AIA_FANCY_TAKEOUT_TARGET_PROB[AI_BEGINNER], scriptSetUdwordCB),
    makeEntry(AIA_FANCY_TAKEOUT_TARGET_RANGE[AI_BEGINNER],scriptSetUdwordCB),
    makeEntry(AIA_FANCY_TAKEOUT_TARGET_PROB[AI_INTERMEDIATE], scriptSetUdwordCB),
    makeEntry(AIA_FANCY_TAKEOUT_TARGET_RANGE[AI_INTERMEDIATE],scriptSetUdwordCB),
    makeEntry(AIA_FANCY_TAKEOUT_TARGET_PROB[AI_ADVANCED], scriptSetUdwordCB),
    makeEntry(AIA_FANCY_TAKEOUT_TARGET_RANGE[AI_ADVANCED],scriptSetUdwordCB),
    makeEntry(AIA_FIGHTER_STRIKE_PROB[AI_BEGINNER],       scriptSetUdwordCB),
    makeEntry(AIA_FIGHTER_STRIKE_RANGE[AI_BEGINNER],      scriptSetUdwordCB),
    makeEntry(AIA_FIGHTER_STRIKE_PROB[AI_INTERMEDIATE],       scriptSetUdwordCB),
    makeEntry(AIA_FIGHTER_STRIKE_RANGE[AI_INTERMEDIATE],      scriptSetUdwordCB),
    makeEntry(AIA_FIGHTER_STRIKE_PROB[AI_ADVANCED],       scriptSetUdwordCB),
    makeEntry(AIA_FIGHTER_STRIKE_RANGE[AI_ADVANCED],      scriptSetUdwordCB),
    makeEntry(AIA_CORVETTE_STRIKE_PROB[AI_BEGINNER],      scriptSetUdwordCB),
    makeEntry(AIA_CORVETTE_STRIKE_RANGE[AI_BEGINNER],     scriptSetUdwordCB),
    makeEntry(AIA_CORVETTE_STRIKE_PROB[AI_INTERMEDIATE],      scriptSetUdwordCB),
    makeEntry(AIA_CORVETTE_STRIKE_RANGE[AI_INTERMEDIATE],     scriptSetUdwordCB),
    makeEntry(AIA_CORVETTE_STRIKE_PROB[AI_ADVANCED],      scriptSetUdwordCB),
    makeEntry(AIA_CORVETTE_STRIKE_RANGE[AI_ADVANCED],     scriptSetUdwordCB),
    makeEntry(AIA_FRIGATE_STRIKE_PROB[AI_BEGINNER],       scriptSetUdwordCB),
    makeEntry(AIA_FRIGATE_STRIKE_RANGE[AI_BEGINNER],      scriptSetUdwordCB),
    makeEntry(AIA_FRIGATE_STRIKE_PROB[AI_INTERMEDIATE],       scriptSetUdwordCB),
    makeEntry(AIA_FRIGATE_STRIKE_RANGE[AI_INTERMEDIATE],      scriptSetUdwordCB),
    makeEntry(AIA_FRIGATE_STRIKE_PROB[AI_ADVANCED],       scriptSetUdwordCB),
    makeEntry(AIA_FRIGATE_STRIKE_RANGE[AI_ADVANCED],      scriptSetUdwordCB),
    makeEntry(AIA_HARASS_BIG_PROB[AI_BEGINNER],           scriptSetUdwordCB),
    makeEntry(AIA_HARASS_BIG_RANGE[AI_BEGINNER],          scriptSetUdwordCB),
    makeEntry(AIA_HARASS_BIG_PROB[AI_INTERMEDIATE],           scriptSetUdwordCB),
    makeEntry(AIA_HARASS_BIG_RANGE[AI_INTERMEDIATE],          scriptSetUdwordCB),
    makeEntry(AIA_HARASS_BIG_PROB[AI_ADVANCED],           scriptSetUdwordCB),
    makeEntry(AIA_HARASS_BIG_RANGE[AI_ADVANCED],          scriptSetUdwordCB),
    makeEntry(AIA_HARASS_SMALL_PROB[AI_BEGINNER],         scriptSetUdwordCB),
    makeEntry(AIA_HARASS_SMALL_RANGE[AI_BEGINNER],        scriptSetUdwordCB),
    makeEntry(AIA_HARASS_SMALL_PROB[AI_INTERMEDIATE],         scriptSetUdwordCB),
    makeEntry(AIA_HARASS_SMALL_RANGE[AI_INTERMEDIATE],        scriptSetUdwordCB),
    makeEntry(AIA_HARASS_SMALL_PROB[AI_ADVANCED],         scriptSetUdwordCB),
    makeEntry(AIA_HARASS_SMALL_RANGE[AI_ADVANCED],        scriptSetUdwordCB),
    makeEntry(AIA_CAPTURE_PROB[AI_BEGINNER],              scriptSetUdwordCB),
    makeEntry(AIA_CAPTURE_RANGE[AI_BEGINNER],             scriptSetUdwordCB),
    makeEntry(AIA_CAPTURE_PROB[AI_INTERMEDIATE],              scriptSetUdwordCB),
    makeEntry(AIA_CAPTURE_RANGE[AI_INTERMEDIATE],             scriptSetUdwordCB),
    makeEntry(AIA_CAPTURE_PROB[AI_ADVANCED],              scriptSetUdwordCB),
    makeEntry(AIA_CAPTURE_RANGE[AI_ADVANCED],             scriptSetUdwordCB),
    makeEntry(AIA_MINE_PROB[AI_BEGINNER],                 scriptSetUdwordCB),
    makeEntry(AIA_MINE_RANGE[AI_BEGINNER],                scriptSetUdwordCB),
    makeEntry(AIA_MINE_PROB[AI_INTERMEDIATE],                 scriptSetUdwordCB),
    makeEntry(AIA_MINE_RANGE[AI_INTERMEDIATE],                scriptSetUdwordCB),
    makeEntry(AIA_MINE_PROB[AI_ADVANCED],                 scriptSetUdwordCB),
    makeEntry(AIA_MINE_RANGE[AI_ADVANCED],                scriptSetUdwordCB),
    makeEntry(AIA_CLOAKGEN_PROB[AI_BEGINNER],             scriptSetUdwordCB),
    makeEntry(AIA_CLOAKGEN_RANGE[AI_BEGINNER],            scriptSetUdwordCB),
    makeEntry(AIA_CLOAKGEN_PROB[AI_INTERMEDIATE],             scriptSetUdwordCB),
    makeEntry(AIA_CLOAKGEN_RANGE[AI_INTERMEDIATE],            scriptSetUdwordCB),
    makeEntry(AIA_CLOAKGEN_PROB[AI_ADVANCED],             scriptSetUdwordCB),
    makeEntry(AIA_CLOAKGEN_RANGE[AI_ADVANCED],            scriptSetUdwordCB),
    makeEntry(AIA_GRAVWELL_PROB[AI_BEGINNER],             scriptSetUdwordCB),
    makeEntry(AIA_GRAVWELL_RANGE[AI_BEGINNER],            scriptSetUdwordCB),
    makeEntry(AIA_GRAVWELL_PROB[AI_INTERMEDIATE],             scriptSetUdwordCB),
    makeEntry(AIA_GRAVWELL_RANGE[AI_INTERMEDIATE],            scriptSetUdwordCB),
    makeEntry(AIA_GRAVWELL_PROB[AI_ADVANCED],             scriptSetUdwordCB),
    makeEntry(AIA_GRAVWELL_RANGE[AI_ADVANCED],            scriptSetUdwordCB),

    makeEntry(AIA_KAMIKAZE_PROB[AI_BEGINNER],    scriptSetUdwordCB),
    makeEntry(AIA_KAMIKAZE_RANGE[AI_BEGINNER],   scriptSetUdwordCB),
    makeEntry(AIA_KAMIKAZE_PROB[AI_INTERMEDIATE],    scriptSetUdwordCB),
    makeEntry(AIA_KAMIKAZE_RANGE[AI_INTERMEDIATE],   scriptSetUdwordCB),
    makeEntry(AIA_KAMIKAZE_PROB[AI_ADVANCED],    scriptSetUdwordCB),
    makeEntry(AIA_KAMIKAZE_RANGE[AI_ADVANCED],   scriptSetUdwordCB),

    makeEntry(AIA_NUM_ARMADA_TEAMS[AI_BEGINNER], scriptSetUbyteCB),
    makeEntry(AIA_NUM_ARMADA_TEAMS[AI_INTERMEDIATE], scriptSetUbyteCB),
    makeEntry(AIA_NUM_ARMADA_TEAMS[AI_ADVANCED], scriptSetUbyteCB),
